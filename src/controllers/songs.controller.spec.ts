...
describe('SongsController', () => {
  ...
  describe('songs', () => {
    it('should retrieve songs', async () => {
        ...
        jest.spyOn(songsService, 'getSongs').mockImplementation(songsMockService.getSongs);
    ...
    it('should retrieve favorite songs', async() => {
        // ARRANGE
        const songsMockService = new SongsMockService();
        jest.spyOn(songsService, 'getFavorites').mockImplementation(songsMockService.getFavorites);
    ...
    it('should add a favorite', async() => {
        // ARRANGE
        const songsMockService = new SongsMockService();
        jest.spyOn(songsService, 'updateFavorite').mockImplementation(songsMockService.updateFavorite);
